          ...
          *******************************************************************************/
             ...
             if (income <= 18550){
                 ...
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                       (151900 - 75300) * 0.25 + (income - 151901) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                        (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
                        (413350 - 231450) * 0.33 + (income - 466950) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
          ...
          *******************************************************************************/
            ...
            if (income <= 9275){
                 ...
                 taxRate = 33;
                  ...
                  tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                        (75950 - 37650) * 0.25 + (115725 - 75950) * 0.28 +
                        (206675 - 115725) * 0.33 + (income - 233475) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
          ...
          *******************************************************************************/
            ...
            if (income <= 13250){
                 ...
                 taxRate = 33;
                  ...
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                        (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 +
                        (413350 - 210800) * 0.33 + (44100 - 413350 ) * 0.35 + (income - 441000) * .396;
                  taxRate = 39.6;
               }//end of else
